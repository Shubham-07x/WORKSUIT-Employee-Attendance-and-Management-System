            ...
            <div className={`d-flex flex-column align-items-center align-items-sm-start ${sidebarOpen ? 'px-3' : 'px-1'} pt-2 text-white min-vh-100`}>
                ...
                >
                    <span className="fs-5 fw-bolder d-flex align-items-center justify-content-center">
                        <img src="/images/worksuite_img.png" alt="Logo Image" style={{ maxWidth: "40px", height: "auto", width:'40px !important', marginLeft:'5px'}} /><h2 style={{fontSize:'22px', fontWeight:'900', marginTop:'0px', marginBottom:'0px', fontFamily:'Quicksand'}}>{sidebarOpen ? 'WORKSUITE' : ''}</h2>
                    </span>
                </Link>
                ...
                <Button variant="btn btn-danger" onClick={handleLogout} className="nav-link-logout mt-auto mb-3 w-100 align-middle">
